...
<head>
    ...
    <link rel="stylesheet" href="assets/jpa/style.css?v=<?php echo time(); ?>">
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/jquery-circle-progress/1.2.2/circle-progress.min.js'></script><script  src="assets/jpa/script.js ?v=<?php echo time(); ?>"></script>
